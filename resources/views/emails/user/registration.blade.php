...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
    <head>
        ...
        <title>{{ __('notifications.mail.user.registration.welcome.html_title', [
                                ...
                                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
                                                        ...
                                                        <table border="0" align="left" cellpadding="0" cellspacing="0" role="presentation" class="row" width="280" style="width:280px;max-width:280px;">
                                                            <tr  >
                                                                <td align="left" class="center-text">
                                                                    <a href="{{ url('/') }}"><img style="width:72px;border:0px;display: inline!important;" src="{{ config('notifications.mail.top_logo') }}" width="72" border="0"       alt="logo"></a>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        <!-- column -->
                                    ...
                                    <tr  >
                                        <td align="center" class="center-text">
                                            <img style="width:320px;border:0px;display: inline!important;" src="{{ config('notifications.mail.welcome_image_url') }}" width="320" border="0"       alt="intro">
                                        </td>
                                    </tr>
                                    <tr  >
                                        <td height="40" style="font-size:40px;line-height:40px;" >&nbsp;</td>
                                    ...
                                    <tr  >
                                        <td class="center-text"  align="center" style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:42px;line-height:52px;font-weight:400;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;">
                                            ...
                                            <div  >
                                                {{ __('notifications.mail.user.registration.welcome.greeting', ['user_name' => $fullName]) }}
                                            </div>
                                    ...
                                    <tr  >
                                        <td class="center-text"  align="justify" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;font-weight:300;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;">

                                            <div  >
                                                {!! __('notifications.mail.user.registration.welcome.content', ['app_name' => config('app.name')]) !!}
                                            </div>
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="0" role="presentation" align="center" class="center-float">
                                                <tr>
                                                    <td align="center"    bgcolor="#d6df58" style="border-radius: 6px;">
                                                        ...
                                                        <a href="{{ config('notifications.mail.welcome_url') }}" target="_blank"    style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:16px;line-height:19px;font-weight:700;font-style:normal;color:#000000;text-decoration:none;letter-spacing:0px;padding: 20px 50px 20px 50px;display: inline-block;"><span>{{ __('notifications.mail.user.registration.action_button') }}</span></a>
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        ...
                                                        <table border="0" align="left" cellpadding="0" cellspacing="0" role="presentation" class="row" width="70" style="width:70px;max-width:70px;">
                                                            <tr  >
                                                                <td align="center">
                                                                    <img style="display:block;width:100%;max-width:70px;border:0px;"    width="70" src="{{ __('notifications.mail.user.registration.icon_one') }}" border="0"  alt="icon">
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        <!-- column -->
                                                        ...
                                                        <table border="0" align="left" cellpadding="0" cellspacing="0" role="presentation" class="row" width="480" style="width:480px;max-width:480px;">
                                                            <tr  >
                                                                <td class="center-text"  align="left" style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:20px;line-height:28px;font-weight:400;font-style:normal;color:#343e9e;text-decoration:none;letter-spacing:0px;">
                                                                    ...
                                                                    <div  >
                                                                        {{ __('notifications.mail.user.registration.headline_one') }}
                                                                    </div>
                                                            ...
                                                            <tr  >
                                                                <td class="center-text container-padding"  align="left" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                                                    ...
                                                                    <div  >
                                                                        {{ __('notifications.mail.user.registration.paragraph_one') }}
                                                                    </div>
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        ...
                                                        <table border="0" align="left" cellpadding="0" cellspacing="0" role="presentation" class="row" width="70" style="width:70px;max-width:70px;">
                                                            <tr  >
                                                                <td align="center">
                                                                    <img style="display:block;width:100%;max-width:70px;border:0px;"    width="70" src="{{ __('notifications.mail.user.registration.icon_two') }}" border="0"  alt="icon">
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        <!-- column -->
                                                        ...
                                                        <table border="0" align="left" cellpadding="0" cellspacing="0" role="presentation" class="row" width="480" style="width:480px;max-width:480px;">
                                                            <tr  >
                                                                <td class="center-text"  align="left" style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:20px;line-height:28px;font-weight:400;font-style:normal;color:#343e9e;text-decoration:none;letter-spacing:0px;">
                                                                    ...
                                                                    <div  >
                                                                        {{ __('notifications.mail.user.registration.headline_two') }}
                                                                    </div>
                                                            ...
                                                            <tr  >
                                                                <td class="center-text container-padding"  align="left" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                                                    ...
                                                                    <div  >
                                                                        {{ __('notifications.mail.user.registration.paragraph_two') }}
                                                                    </div>
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        ...
                                                        <table border="0" align="left" cellpadding="0" cellspacing="0" role="presentation" class="row" width="70" style="width:70px;max-width:70px;">
                                                            <tr  >
                                                                <td align="center">
                                                                    <img style="display:block;width:100%;max-width:70px;border:0px;"    width="70" src="{{ __('notifications.mail.user.registration.icon_three') }}" border="0"  alt="icon">
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        <!-- column -->
                                                        ...
                                                        <table border="0" align="left" cellpadding="0" cellspacing="0" role="presentation" class="row" width="480" style="width:480px;max-width:480px;">
                                                            <tr  >
                                                                <td class="center-text"  align="left" style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:20px;line-height:28px;font-weight:400;font-style:normal;color:#343e9e;text-decoration:none;letter-spacing:0px;">
                                                                    ...
                                                                    <div  >
                                                                        {{ __('notifications.mail.user.registration.headline_three') }}
                                                                    </div>
                                                            ...
                                                            <tr  >
                                                                <td class="center-text container-padding"  align="left" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                                                    ...
                                                                    <div  >
                                                                        {{ __('notifications.mail.user.registration.paragraph_three') }}
                                                                    </div>
                                ...
                                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
                                                        ...
                                                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                            <tr>
                                                                <td   class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">
                                                                    @if( config('notifications.mail.instagram_url') != '')
                                                                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                            <tr>
                                                                                <td width="10"></td>
                                                                                <td align="center">
                                                                                    <a href="{{ config('notifications.mail.facebook_url') }}"><img style="width:36px;border:0px;display: inline!important;" src="https://upload.wikimedia.org/wikipedia/en/thumb/0/04/Facebook_f_logo_%282021%29.svg/200px-Facebook_f_logo_%282021%29.svg.png" width="36" border="0"       alt="icon"></a>
                                                                                </td>
                                                                                <td width="10"></td>
                                                                            </tr>
                                                                        </table>
                                                                    ...
                                                                    @if( config('notifications.mail.instagram_url') != '')
                                                                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                            <tr>
                                                                                <td width="10"></td>
                                                                                <td align="center">
                                                                                    <a href="{{ config('notifications.mail.instagram_url') }}"><img style="width:36px;border:0px;display: inline!important;" src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/Instagram_icon.png/2048px-Instagram_icon.png" width="36" border="0"       alt="icon"></a>
                                                                                </td>
                                                                                <td width="10"></td>
                                                                            </tr>
                                                                        </table>
                                                                ...
                                                                <td   class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">
                                                                    @if( config('notifications.mail.twitter_url') != '')
                                                                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                            <tr>
                                                                                <td width="10"></td>
                                                                                <td align="center">
                                                                                    <a href="{{ config('notifications.mail.twitter_url') }}"><img style="width:36px;border:0px;display: inline!important;" src="{{ asset('assets/img/emails/Twitter.png') }}" width="36" border="0"       alt="icon"></a>
                                                                                </td>
                                                                                <td width="10"></td>
                                                                            </tr>
                                                                        </table>
                                                                ...
                                                                <td   class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">
                                                                    @if( config('notifications.mail.pinterest_url') != '')
                                                                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                            <tr>
                                                                                <td width="10"></td>
                                                                                <td align="center">
                                                                                    <a href="{{ config('notifications.mail.pinterest_url') }}"><img style="width:36px;border:0px;display: inline!important;" src="{{ asset('assets/img/emails/Pinterest.png') }}" width="36" border="0"       alt="icon"></a>
                                                                                </td>
                                                                                <td width="10"></td>
                                                                            </tr>
                                                                        </table>
                                    ...
                                    <tr  >
                                        <td class="center-text"  align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                            ...
                                            <div  >
                                                {{ config('notifications.mail.street_address') }}
                                            </div>
                                    ...
                                    <tr  >
                                        <td class="center-text"  align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                            ...
                                            <a href="tel:{{ config('notifications.mail.phone_number') }}"    style="color:#6e6e6e;"><span>{{ config('notifications.mail.phone_number') }}</span></a>
                                    ...
                                    <tr  >
                                        <td class="center-text"  align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                            ...
                                            <a href="mailto:{{ config('notifications.mail.info_email') }}"    style="color:#6e6e6e;"><span>{{ config('notifications.mail.info_email') }}</span></a> - <a href="{{ url('/') }}"    style="color:#6e6e6e;"><span>{{ url('/') }}</span></a>
                                    ...
                                    <tr  >
                                        <td align="center">
                                        @if( config('notifications.mail.play_url') != '' || config('notifications.mail.ios_url') != '' )
                                            <!-- Buttons -->
                                                    ...
                                                    <tr>
                                                        <td align="center">
                                                            ...
                                                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                <tr  >
                                                                    <td align="center">
                                                                        <a href="{{config('notifications.mail.ios_url')}}"><img style="display:block;width:100%;max-width:117px;border:0px;"    width="117" src="{{ asset('assets/img/emails/App-Store.png') }}" border="0"  alt="icon"></a>
                                                                    </td>
                                                                    <td width="10" style="width: 10px;"></td>
                                                                    <td align="center">
                                                                        <a href="{{config('notifications.mail.play_url')}}"><img style="display:block;width:100%;max-width:117px;border:0px;"    width="117" src="{{ asset('assets/img/emails/Google-play.png') }}" border="0"  alt="icon"></a>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            <!-- column -->
